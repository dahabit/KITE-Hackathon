...
const WebDriverFactory = require('./kite-common-js-lib/wdmgmt/WebDriverFactory.js');
...
(async function testScript() {
  ...
  testReport['steps'] = steps;
	...
	let driver;
  try {
		driver = await WebDriverFactory.getDriver(capabilities.browserName, capabilities.remoteAddress)
