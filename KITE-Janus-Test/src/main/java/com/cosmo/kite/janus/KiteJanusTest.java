package com.cosmo.kite.janus;

import com.cosmo.kite.janus.checks.AllVideoCheck;
import com.cosmo.kite.janus.checks.FirstVideoCheck;
import com.cosmo.kite.janus.steps.*;
      ...
      for (WebDriver webDriver : this.webDriverList) {
        ...
        if (!this.fastRampUp()) {
          ...
          if (this.getNWInstConfig() != null) {
            ...
            callable.addStep(new GetStatsStep(webDriver, maxUsersPerRoom,
