...
public class Browser extends EndPoint {
  ...
  private boolean isEqualToPlatform(String platform) {
    if (Utility.areBothNull(this.platformName, platform)) {
      return true;
    } else if (Utility.areBothNotNull(this.platformName, platform)) {
  ...
  public JsonObjectBuilder getJsonObjectBuilderForResult() {
    ...
    if (Utility.isNotNullAndNotEmpty(this.userAgentPlatform)) {
      ...
      if (myPlatform.equalsIgnoreCase("ANY") && Utility.isNotNullAndNotEmpty(this.platformName)) {
        myPlatform = this.platformName;
      }
    } else if (Utility.isNotNullAndNotEmpty(this.platformName)) {
      myPlatform = this.platformName;
    }
    if (myPlatform != null) {
